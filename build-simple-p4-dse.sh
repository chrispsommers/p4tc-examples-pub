...
sudo ip netns add rocelab-roce-1
sudo ip netns add rocelab-roce-2
...
sudo ip link set dev p4port0 netns rocelab-roce-1
sudo ip link set dev port1 netns p4node
sudo ip link set dev p4port1 netns rocelab-roce-2
